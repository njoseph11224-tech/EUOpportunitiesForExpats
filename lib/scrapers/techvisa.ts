...
export async function scrapeTechVisaPlatforms(): Promise<Partial<Job>[]> {
  return [
    {
      title: 'Senior Cloud API & Software Engineer (EU Relocation)',
      ...
      country_code: 'PT',
      source: 'LinkedIn',
      original_url: 'https://landing.jobs/jobs/cloud-api-software-engineer-lisbon',
      description: 'Landing.jobs is recruiting a Senior Software Engineer for European clients. Sponsoring Tech Visa Portugal (fast-track tech resident visa for international IT talent).',
    ...
    {
      title: 'European Cloud Infrastructure & DevOps Lead',
      ...
      original_url: 'https://www.eurotechjobs.com/jobs/cloud-infrastructure-brussels',
      description: 'EuroTechJobs is searching for a Cloud Infrastructure Architect for EU tech companies in Brussels. Sponsoring Belgian Single Permit (work & residence permit).',
      summary: 'Belgian Single Permit visa sponsorship for cloud infrastructure experts in Brussels.',
      visa_sponsorship: true,
