    ...
    <div className="mb-8">
      ...
      <div className="flex flex-col sm:flex-row items-center gap-3 mb-5">
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto justify-between sm:justify-end">
          <button
            onClick={onReset}
            className="px-4 py-3 bg-white border border-slate-200 hover:border-slate-300 text-slate-600 rounded-2xl text-xs font-bold flex items-center gap-2 shadow-sm transition-all"
          >
      ...
      {/* Exact Pill Dropdowns Row from User Image */}
      <div className="flex items-center gap-3 overflow-x-auto pb-2 scrollbar-none flex-wrap">
        {/* Type Select */}
        <div className="relative">
          <select
            value={filters.category || 'ALL'}
            onChange={e => handleFieldChange('category', e.target.value)}
            className="filter-pill-select pr-8 appearance-none"
          >
